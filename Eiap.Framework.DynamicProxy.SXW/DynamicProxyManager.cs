...
namespace Eiap.Framework.Base.DynamicProxy.SXW
{
    public class DynamicProxyManager : IDynamicProxyManager
    {
        ...
        public object Create(Type interfaceType, IDynamicProxyInterceptor interceptorInstance, object objInstance)
        {
            Type interceptorType = interceptorInstance.GetType();
            ...
            return Activator.CreateInstance(t, new object[] { interceptorInstance, objInstance });
        }
